import { Repositories } from "@/lib/interface/interface";

export default function RepositoryItem({ title, description, stargazers_count }: Repositories) {
    return (
        <div className="bg-gray-300 py-2 px-3">
            <div className="flex">

                <p className="text-lg font-bold w-0 flex-1 min-w-0 break-words">{title}</p>
